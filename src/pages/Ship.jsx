...
const Ship = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto py-20 px-4 text-center animate-fade-in">
            ...
            <h1 className="text-5xl font-serif font-bold text-primary mb-4">Ready for Launch</h1>
            ...
            <div className="card max-w-lg mx-auto p-12 bg-surface text-left border-none shadow-xl border-t-4 border-accent">
